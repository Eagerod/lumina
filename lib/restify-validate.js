...
/**
	@return {RestifyValidatorMethod} A default validator that will take in an 
...
/**
	@return {RestifyValidatorMethod} A default validator that will take in an 
		...
		present.
*/
RestifyValidator.permittedBodyFieldValidator = function() {
	return function(fields) {
		if ( !(fields instanceof Array) ) {
			throw new Error("Restricted body fields must be an array");
		}
...
/**
	...
	@param validator {RestifyValidatorMethod} A validator method that's used to 
...
/**
	Create a function that handles sending in the pass parameter to 
		{@link RestifyValidatorMethod} methods. Allows the execution chain to 
	...
	@param handler {RestifyValidatorMethod} - The validator method that will be
